...
PROCEDURE Main()
   ...
   FOR i := 1 TO MAX_PARTICLES
      ...
      aMouseTail[ NCOLOR, i ] := { GetRandomValue( 0, 255 ), GetRandomValue( 0, 255 ), GetRandomValue( 0, 255 ), 255 }
   ...
   DO WHILE ! WindowShouldClose()
      ...
      FOR i := 1 TO MAX_PARTICLES
         IF aMouseTail[ ACTIVE, i ]
            DrawTexturePro( aSmoke, { nRectangle[ RECTANGLE_X ], nRectangle[ RECTANGLE_Y ], aSmoke[ TEXTURE2D_WIDTH ], Int( aSmoke[ TEXTURE2D_HEIGHT ] ) }, ;
               ...
               { ( aSmoke[ TEXTURE2D_WIDTH ] * aMouseTail[ SIZE, i ] / 2.0 ), ( aSmoke[ TEXTURE2D_HEIGHT ] * aMouseTail[ SIZE, i ] / 2.0 ) }, aMouseTail[ ROTATION, i ], Fade( aMouseTail[ NCOLOR, i ], aMouseTail[ ALPHA, i ] ) )
         ENDIF
      NEXT
