...
PROCEDURE Main()
   ...
   DO WHILE ! WindowShouldClose()
      ...
      aPanelContentRec[ RECTANGLE_WIDTH ] := GuiSliderBar( { 590, 385, 145, 15 }, "WIDTH", aPanelContentRec[ RECTANGLE_WIDTH ], 1, 600, 1 )
      aPanelContentRec[ RECTANGLE_HEIGHT ] := GuiSliderBar( { 590, 410, 145, 15 }, "HEIGHT", aPanelContentRec[ RECTANGLE_HEIGHT ], 1, 400, 1 )
...
STATIC PROCEDURE DrawStyleEditControls()
   ...
   GuiSpinner( { 670, 240, 90, 20 }, "1", nStyle, 0, 14, .F. )
   ...
   GuiSpinner( { 670, 320, 90, 20 }, "1", nStyle, 0, 14, .F. )
   ...
   GuiSpinner( { 670, 345, 90, 20 }, "1", nStyle, 2, 100, .F. )
   GuiSetStyle( SCROLLBAR, SCROLL_SLIDER_SIZE, nStyle )   // ?
/*
   cText := GuiGetStyle( LISTVIEW, SCROLLBAR_SIDE ) == SCROLLBAR_LEFT_SIDE ? "SCROLLBAR: LEFT" : "SCROLLBAR: RIGHT"
   nStyle := GuiToggle( { 560, 110, 200, 35 }, cText, GuiGetStyle( LISTVIEW, SCROLLBAR_SIDE ) )
   GuiSetStyle( LISTVIEW, SCROLLBAR_SIDE, nStyle )
*/
